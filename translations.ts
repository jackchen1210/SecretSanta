...
export const translations = {
  en: {
    ...
    reset: "Reset",
    resetConfirm: "Are you sure? This will delete all pairings, passwords, and wishlists!",
  ...
  zh: {
    appTitle: "聖誕天使交換禮物",
    reset: "重置",
    resetConfirm: "確定要重置嗎？這將刪除所有配對、密碼和願望清單！",
    whoAreYou: "你是哪一位？",
  ...
  ja: {
    appTitle: "シークレットサンタ",
    reset: "リセット",
    resetConfirm: "本当にリセットしますか？すべてのペアリング、パスワード、ウィッシュリストが削除されます！",
    whoAreYou: "あなたのお名前は？",
  ...
  ko: {
    appTitle: "시크릿 산타",
    reset: "초기화",
    resetConfirm: "정말 초기화하시겠습니까? 모든 매칭, 비밀번호, 위시리스트가 삭제됩니다!",
    whoAreYou: "누구신가요?",
  ...
  es: {
    ...
    reset: "Reiniciar",
    resetConfirm: "¿Estás seguro? ¡Esto eliminará todos los emparejamientos, contraseñas y listas de deseos!",
